...
public  class FxmlStatController implements Initializable   {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        LineChart<String, Number> lc4= createLineChart4(coutMax,dataPrix);
    ...
    private LineChart<String, Number> createLineChart4(int coutMax ,Integer[] dataPrix) {
        //defining the axes
        final CategoryAxis xAxis = new CategoryAxis();
        final NumberAxis yAxis = new NumberAxis();
        xAxis.setLabel("prix");
        ...
        //creating the chart
        final LineChart<String, Number> lineChart = new LineChart<>(xAxis, yAxis);
        lineChart.setTitle("Nombre d'offres/Prix");

        //defining a series
        XYChart.Series<String, Number> seriesAge = new LineChart.Series<>();
        seriesAge.setName("nombre d'offres par prix");

        //populating the series with data

        for (int i = 1; i < coutMax+6 ; i=i+5 ) {
            String prix=""+i+"-"+(i+4);

            XYChart.Data<String, Number> data1 = new LineChart.Data<>(prix ,dataPrix[i]);
            seriesAge.getData().add(data1);
        ...
        lineChart.getData().add(seriesAge);
        System.out.println("Function  44444444444444444444444");
        return lineChart;
    }
